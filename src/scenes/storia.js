...
function preload(s) {
    // Carica tavole
    tavola1 = PP.assets.image.load(s, "assets/situe/t1.png");
    tavola2 = PP.assets.image.load(s, "assets/situe/scena1.png");
    tavola3 = PP.assets.image.load(s, "assets/situe/t2.png");
    tavola4 = PP.assets.image.load(s, "assets/situe/scena2.png");
    tavola5 = PP.assets.image.load(s, "assets/situe/t3.png");
