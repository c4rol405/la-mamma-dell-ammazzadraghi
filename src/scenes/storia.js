...
function seleziona_tavole(s) {
    ...
    if (numero_tavola === tavole.length - 1) {
        pulsante_gotohome = PP.assets.image.add(s, p_gotohome, 590, 630, 0.5, 0.5);
        pulsante_gotogame = PP.assets.image.add(s, p_gotogame, 690, 630, 0.5, 0.5);
        ...
        // pulsanti normali
        pulsante_avanti = PP.assets.image.add(s, p_avanti, 690, 630, 0.5, 0.5);
        pulsante_indietro = PP.assets.image.add(s, p_indietro, 590, 630, 0.5, 0.5);
